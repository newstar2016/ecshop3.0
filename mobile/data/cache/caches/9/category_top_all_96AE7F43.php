<?php exit;?>a:3:{s:8:"template";a:4:{i:0;s:80:"F:\phpStudy\PHPTutorial\WWW\my_ecshop\mobile/themes/default/category_top_all.dwt";i:1;s:83:"F:\phpStudy\PHPTutorial\WWW\my_ecshop\mobile/themes/default/library/page_header.lbi";i:2;s:78:"F:\phpStudy\PHPTutorial\WWW\my_ecshop\mobile/themes/default/library/search.lbi";i:3;s:83:"F:\phpStudy\PHPTutorial\WWW\my_ecshop\mobile/themes/default/library/page_footer.lbi";}s:7:"expires";i:1511152675;s:8:"maketime";i:1511149075;}<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
          ...
          <li>
            ...
            <div class="pull-left ect-category-right">
                ...
                <div class="ect-category-child">
                                <a href="/mobile/index.php?m=default&c=category&a=all&id=27">大家电</a>
                     
        </div>
      </li>
           <li>
     	        <a href="/mobile/index.php?m=default&c=category&a=index&id=25">
        <div class="media panel-body">
            <img class="pull-left" src="/mobile/data/common/images/no_picture.gif">
            <div class="pull-left ect-category-right">
                <h3>数码时尚</h3>
           ...
           <li>
     	        <a href="/mobile/index.php?m=default&c=category&a=index&id=18">
        <div class="media panel-body">
            <img class="pull-left" src="/mobile/data/common/images/no_picture.gif">
            <div class="pull-left ect-category-right">
                <h3>智能硬件</h3>
           ...
           <li>
     	        <a href="/mobile/index.php?m=default&c=category&a=index&id=22">
        <div class="media panel-body">
            <img class="pull-left" src="/mobile/data/common/images/no_picture.gif">
            <div class="pull-left ect-category-right">
                <h3>移动电源</h3>
           ...
           <li>
            ...
            <div class="pull-left ect-category-right">
                ...
                <div class="ect-category-child">
                                <a href="/mobile/index.php?m=default&c=category&a=index&id=3">小型手机</a>
           ...
           <li>
     	        <a href="/mobile/index.php?m=default&c=category&a=index&id=12">
        <div class="media panel-body">
            <img class="pull-left" src="/mobile/data/common/images/no_picture.gif">
            <div class="pull-left ect-category-right">
                <h3>充值卡</h3>
           ...
           <li>
     	        <a href="/mobile/index.php?m=default&c=category&a=index&id=16">
        <div class="media panel-body">
            <img class="pull-left" src="/mobile/data/common/images/no_picture.gif">
            <div class="pull-left ect-category-right">
                <h3>服装</h3>
           ...
           <li>
            ...
            <div class="pull-left ect-category-right">
                ...
                <div class="ect-category-child">
                                <a href="/mobile/index.php?m=default&c=category&a=index&id=24">数码时尚</a>
                                            <a href="/mobile/index.php?m=default&c=category&a=index&id=20">保护壳</a>
